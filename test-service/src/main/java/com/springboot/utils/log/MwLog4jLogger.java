...
/**
 *
 *  MW's Log4jLogger implementation
 *
 * FQCN  (The fully qualified class name of the logger entry point, used to determine the caller class and
 *            method when location information needs to be logged) is changed to MwLogger's FQCN
 *
 * Created by Jacobs Lei on 2017/12/1.
 * @author Jacobs Lei
 */
public class MwLog4jLogger implements LocationAwareLogger, Serializable {

    public static final String FQCN = MwLogger.class.getName();
    ...
    public MwLog4jLogger(final ExtendedLogger logger, final String name) {
        this.logger = logger;
